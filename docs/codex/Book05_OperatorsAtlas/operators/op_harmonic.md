# Operator Hub: Harmonic `⊗`

## 1) Core Definition
- **Formal definition**: `Harmonic` maps state according to its governing pillar invariants.
...
- **Codex examples**: `Book08_SongOfFlame` and linked ceremony walkthroughs.

## 2) Engine Implementation
- **Primary engine**: [Phoenix Engine](../../../engines/phoenix_engine.md)
- **Algorithm sketch**: normalize input → apply `Harmonic` transform → validate invariants.
...
- Used in [Ceremony Harmonic Tuning](../../Book09_PhoenixArchive/ceremonies/ceremony_harmonic_tuning.md).
...
## 6) Codex Navigation
- Defining chapters: `Book08_SongOfFlame`.
- Usage chapters: Books 09, 11, and 12 operator applications.
- Related in-pillar operators: [genesis](op_genesis.md), [recursive](op_recursive.md), [apex](op_apex.md).
