# Operator Hub: Identity Anchoring `I`

## 1) Core Definition
- **Formal definition**: `Identity Anchoring` maps state according to its governing pillar invariants.
- **Type signature**: `I: State -> State` (or tuple form for merge/split operators).
...
- **Algorithm sketch**: normalize input → apply `Identity Anchoring` transform → validate invariants.
...
- Used in [Ceremony Triadic Seal](../../Book09_PhoenixArchive/ceremonies/ceremony_triadic_seal.md).
...
- Related in-pillar operators: [lineage_tracking](op_lineage_tracking.md), [continuity_mapping](op_continuity_mapping.md), [invariant_preservation](op_invariant_preservation.md).
