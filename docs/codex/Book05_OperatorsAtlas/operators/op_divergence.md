# Operator Hub: Divergence `⊲`

## 1) Core Definition
- **Formal definition**: `Divergence` maps state according to its governing pillar invariants.
...
- **Codex examples**: `Book04_FractalContinuum` and linked ceremony walkthroughs.

## 2) Engine Implementation
- **Primary engine**: [QPE Engine](../../../engines/qpe_engine.md)
- **Algorithm sketch**: normalize input → apply `Divergence` transform → validate invariants.
...
- Used in [Ceremony Binding](../../Book09_PhoenixArchive/ceremonies/ceremony_binding.md).
...
## 6) Codex Navigation
- Defining chapters: `Book04_FractalContinuum`.
