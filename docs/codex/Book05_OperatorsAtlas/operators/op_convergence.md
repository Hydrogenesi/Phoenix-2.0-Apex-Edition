# Operator Hub: Convergence `⊳`

## 1) Core Definition
- **Formal definition**: `Convergence` maps state according to its governing pillar invariants.
...
- **Codex examples**: `Book11_OperatorsTestament` and linked ceremony walkthroughs.

## 2) Engine Implementation
- **Primary engine**: [QPE Engine](../../../engines/qpe_engine.md)
- **Algorithm sketch**: normalize input → apply `Convergence` transform → validate invariants.
...
- Used in [Ceremony Convergence](../../Book09_PhoenixArchive/ceremonies/ceremony_convergence.md).
...
## 6) Codex Navigation
- Defining chapters: `Book11_OperatorsTestament`.
