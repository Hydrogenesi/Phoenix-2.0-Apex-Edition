...
## Name & Pillar
- **Name**: Harmonic Operator
- **Pillar**: Phoenix

## Type
`state × resonance -> aligned_state`

## Definition
For state `x`, `⊗(x)` applies the canonical harmonic operator transform while preserving admissible invariants.
...
## Tri-Link Dashboard
- **Engine module**: [Module reference](../../../engines/phoenix_detailed.md#module-harmonic)
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_harmonic_attunement.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-harmonic)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-harmonic-weave)
