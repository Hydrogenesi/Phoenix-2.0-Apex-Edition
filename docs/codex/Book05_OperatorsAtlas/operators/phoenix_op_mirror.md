...
## Definition
For state `x`, `⊞(x)` applies the canonical mirror operator transform while preserving admissible invariants.
...
## Tri-Link Dashboard
- **Engine module**: [Module reference](../../../engines/phoenix_detailed.md#module-mirror)
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_mirror_binding.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-mirror)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-mirror-fold)
