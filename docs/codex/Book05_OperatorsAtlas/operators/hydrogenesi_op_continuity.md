...
## Name & Pillar
- **Name**: Continuity Mapping
- **Pillar**: Hydrogenesi

## Type
`state_t × state_t1 -> continuity_map`

## Definition
For state `x`, `C(x)` applies the canonical continuity mapping transform while preserving admissible invariants.
...
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_continuity_span.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-continuity)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-continuity-arc)
