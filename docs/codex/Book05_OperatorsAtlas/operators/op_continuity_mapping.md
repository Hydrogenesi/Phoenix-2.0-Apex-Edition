# Operator Hub: Continuity Mapping `C`

## 1) Core Definition
- **Formal definition**: `Continuity Mapping` maps state according to its governing pillar invariants.
- **Type signature**: `C: State -> State` (or tuple form for merge/split operators).
...
- **Algorithm sketch**: normalize input → apply `Continuity Mapping` transform → validate invariants.
...
- Used in [Ceremony Continuity Bridge](../../Book09_PhoenixArchive/ceremonies/ceremony_continuity_bridge.md).
...
- Related in-pillar operators: [lineage_tracking](op_lineage_tracking.md), [identity_anchoring](op_identity_anchoring.md), [invariant_preservation](op_invariant_preservation.md).
