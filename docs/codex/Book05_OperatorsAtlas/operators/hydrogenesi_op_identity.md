...
## Type
`state -> identity_locked_state`

## Definition
For state `x`, `I(x)` applies the canonical identity anchoring transform while preserving admissible invariants.
...
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_identity_anchor.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-identity)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-identity-pin)
