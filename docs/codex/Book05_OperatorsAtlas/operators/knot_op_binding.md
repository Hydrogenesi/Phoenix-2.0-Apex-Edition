...
## Definition
For state `x`, `B(x)` applies the canonical knot binding transform while preserving admissible invariants.
...
## Tri-Link Dashboard
- **Engine module**: [Module reference](../../../engines/dragon_detailed.md#coordination-protocols)
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_knot_binding.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-binding)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-binding-lock)
