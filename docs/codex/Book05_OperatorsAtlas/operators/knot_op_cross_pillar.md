...
## Name & Pillar
- **Name**: Cross-Pillar Knot
- **Pillar**: Knot

## Type
`phoenix × hydrogenesi × third -> knot`

## Definition
For state `x`, `Ck(x)` applies the canonical cross-pillar knot transform while preserving admissible invariants.
...
## Tri-Link Dashboard
- **Engine module**: [Module reference](../../../engines/architecture.md#operator-flow-and-data-contracts)
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_cross_pillar_bridge.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-cross-pillar)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-cross-weave)
