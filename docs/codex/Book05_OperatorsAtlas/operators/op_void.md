...
## 1) Core Definition
- **Formal definition**: `Void` maps state according to its governing pillar invariants.
...
- **Codex examples**: `Book01_Genesis_Origin` and linked ceremony walkthroughs.

## 2) Engine Implementation
- **Primary engine**: [Phoenix Engine](../../../engines/phoenix_engine.md)
- **Algorithm sketch**: normalize input → apply `Void` transform → validate invariants.
...
- Used in [Ceremony Void Return](../../Book09_PhoenixArchive/ceremonies/ceremony_void_return.md).
...
## 6) Codex Navigation
- Defining chapters: `Book01_Genesis_Origin`.
- Usage chapters: Books 09, 11, and 12 operator applications.
- Related in-pillar operators: [genesis](op_genesis.md), [harmonic](op_harmonic.md), [recursive](op_recursive.md).
