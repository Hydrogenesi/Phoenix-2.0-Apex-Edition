...
## Definition
For state `x`, `⊛(x)` applies the canonical recursive operator transform while preserving admissible invariants.
...
## Tri-Link Dashboard
- **Engine module**: [Module reference](../../../engines/phoenix_detailed.md#module-recursive)
- **Ceremony sequence**: [Linked ceremony](../../Book09_PhoenixArchive/ceremonies/ceremony_recursion_lattice.md)
- **Sigil**: [Sigil dictionary](../../Book09_PhoenixArchive/ceremonies/sigils.md#sigil-recursive)
- **Gesture**: [Gesture dictionary](../../Book09_PhoenixArchive/ceremonies/gestures.md#gesture-recursion-loop)
